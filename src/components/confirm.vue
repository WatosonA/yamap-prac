...
<div class="container">
    ...
    <div class="step">
        <ul class="step-list">
            ...
            <li class=""><span class="active"><span class="line2-text1">STEP2</span><span class="line2-text2">ご入力内容のご確認</span></span></li>
...
export default {
    ...
    methods: {
        ...
        doSave() {
            ...
            this.$router.push({ name: 'complete', params: {email: this.form.email} });
        }
    }
}
</script>
